...
class Program {
    static void Main(string[] args) {
        ...
        Indica i1 = new Indica("Petrol", 5, "GJ-04-DA-0204", IVehicle.Renttype.Day, 10, 13, new DateOnly(2020, 12,16 ));

        MercedesBenz mb1 = new MercedesBenz("Diesel",7, "GJ-11-AB-0786", IVehicle.Renttype.KM, 3, 17, new DateOnly(2021, 07,18 ));

        Qualis q1 = new Qualis("Diesel", 7, "GJ-04-CR-5700", IVehicle.Renttype.KM, 7, 5, new DateOnly(2021, 11,21));

        Qualis q2 = new Qualis("CNG", 4, "GJ-01-IJ-0001", IVehicle.Renttype.KM, 15, 14, new DateOnly(2022, 02,28 ));

        MercedesBenz mb2 = new MercedesBenz("Petrol",7, "GJ-01-BA-7800", IVehicle.Renttype.KM, 3, 17, new DateOnly(2020, 10,26 ));
